...
|------------------------------|------------------|
|<img src="./gif/회원가입-영상.gif" alt="시작페이지" width="300"/> |<img src="./gif/투두영상.gif" alt="할 일, tts" width="300"/> |



| 일정 | 일정 알람 |
|------|----------|
|<img src="./gif/일정생성-달력-조회.gif" alt="일정" width="300"/> |<img src="./gif/일정알람-영상.gif" alt="일정알람" width="300"/> |
